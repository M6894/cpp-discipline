// 15
// Note, this cpp file should be named rectangle.h to pass the testing system
#include "15-build-rectangle.h"
...
большом проекте. В частности, в нём должна быть решена проблема двойного включения.
*/